...
public class PastelItems {
    ...
    public static final DeferredItem<Item> MOONSTONE_SHARD = register(simple(item(
        "moonstone_shard", () -> new CloakedItem(
            IS.of(), PastelAdvancements.Midgame.BREAK_DECAYED_BEDROCK, WHITE_DYE), InkColors.WHITE
    )));
    ...
    public static final DeferredItem<Item> TOPAZ_POWDER = register(simple(item(
        "topaz_powder", () -> new GemstonePowderItem(
            IS.of(), PastelAdvancements.Hidden.CollectShards.TOPAZ, BuiltinGemstoneColor.CYAN, CYAN_DYE), InkColors.CYAN
    )));
    public static final DeferredItem<Item> AMETHYST_POWDER = register(simple(item(
        "amethyst_powder", () -> new GemstonePowderItem(
            IS.of(), PastelAdvancements.Hidden.CollectShards.AMETHYST, BuiltinGemstoneColor.MAGENTA, MAGENTA_DYE),
        InkColors.MAGENTA
    )));
    public static final DeferredItem<Item> CITRINE_POWDER = register(simple(item(
        "citrine_powder", () -> new GemstonePowderItem(
            IS.of(), PastelAdvancements.Hidden.CollectShards.CITRINE, BuiltinGemstoneColor.YELLOW, YELLOW_DYE),
        InkColors.YELLOW
    )));
    public static final DeferredItem<Item> ONYX_POWDER = register(simple(item(
        "onyx_powder", () -> new GemstonePowderItem(
            IS.of(), PastelAdvancements.CREATE_ONYX_SHARD, BuiltinGemstoneColor.BLACK, BLACK_DYE), InkColors.BLACK
    )));
    public static final DeferredItem<Item> MOONSTONE_POWDER = register(simple(item(
        "moonstone_powder", () -> new GemstonePowderItem(
            IS.of(), PastelAdvancements.Midgame.COLLECT_MOONSTONE_SHARD, BuiltinGemstoneColor.WHITE, WHITE_DYE),
        InkColors.WHITE
    )));
    ...
    public static final DeferredItem<Item> NEOLITH = register(simple(item(
        "neolith", () -> new CloakedItemWithLoomPattern(
            IS.of(Rarity.UNCOMMON), PastelAdvancements.Midgame.CRAFT_BOTTLE_OF_FAILING, GUNPOWDER,
    ...
    public static final DeferredItem<Item> BEDROCK_DUST = register(simple(item(
        "bedrock_dust", () -> new CloakedItemWithLoomPattern(
            IS.of(Rarity.UNCOMMON), PastelAdvancements.Midgame.BREAK_DECAYED_BEDROCK, GUNPOWDER,
    ...
    public static final DeferredItem<MidnightAberrationItem> MIDNIGHT_ABERRATION = register(simple(item(
        "midnight_aberration", () -> new MidnightAberrationItem(
            IS.of(Rarity.UNCOMMON), PastelAdvancements.Midgame.CREATE_MIDNIGHT_ABERRATION,
    ...
    public static final DeferredItem<Item> MIDNIGHT_CHIP = register(simple(item(
        "midnight_chip", () -> new CloakedItem(
            IS.of(Rarity.UNCOMMON), PastelAdvancements.Midgame.CREATE_MIDNIGHT_ABERRATION, GRAY_DYE), InkColors.GRAY
    )));

    public static final DeferredItem<Item> BISMUTH_FLAKE = register(simple(item(
        "bismuth_flake", () -> new CloakedItem(
            IS.of(Rarity.UNCOMMON), PastelAdvancements.Midgame.ENTER_DIMENSION, CYAN_DYE), InkColors.CYAN
    )));
    ...
    public static final DeferredItem<Item> RAW_MALACHITE = register(simple(item(
        "raw_malachite",
        () -> new CloakedItem(IS.of(Rarity.UNCOMMON), PastelAdvancements.Milestones.REVEAL_MALACHITE, GREEN_DYE),
        InkColors.GREEN
    )));
    public static final DeferredItem<Item> PURE_MALACHITE = register(simple(item(
        "pure_malachite", () -> new CloakedItem(
            IS.of(Rarity.UNCOMMON), PastelAdvancements.Milestones.REVEAL_MALACHITE, GREEN_DYE), InkColors.GREEN
    )));
    ...
    public static final DeferredItem<Item> DOWNSTONE_FRAGMENTS = register(simple(item(
        "downstone_fragments", () -> new CloakedItem(
            IS.of(16, Rarity.UNCOMMON), PastelAdvancements.Lategame.FIND_EXCAVATION_SITE, LIGHT_GRAY_DYE),
        InkColors.LIGHT_GRAY
    )));
    public static final DeferredItem<Item> RESONANCE_SHARD = register(simple(item(
        "resonance_shard", () -> new CloakedItem(
            IS.of(16, Rarity.UNCOMMON), PastelAdvancements.Lategame.STRIKE_UP_HUMMINGSTONE_HYMN, LIGHT_BLUE_DYE),
        InkColors.WHITE
    )));
    ...
    public static final DeferredItem<Item> QUITOXIC_POWDER = register(simple(item(
        "quitoxic_powder",
        () -> new CloakedItem(IS.of(), PastelAdvancements.Milestones.REVEAL_QUITOXIC_REEDS, PURPLE_DYE),
        InkColors.PURPLE
    )));
    public static final DeferredItem<Item> STORM_STONE = register(simple(item(
        "storm_stone", () -> new StormStoneItem(IS.of(), PastelAdvancements.Milestones.REVEAL_STORM_STONES, YELLOW_DYE),
        InkColors.LIGHT_BLUE
    )));
    ...
    public static final DeferredItem<CloakedItem> STAR_FRAGMENT = register(simple(item(
        "star_fragment",
        () -> new CloakedItem(IS.of(16), PastelAdvancements.Milestones.UNLOCK_SHOOTING_STARS, PURPLE_DYE),
        InkColors.PURPLE
    )));
    public static final DeferredItem<Item> STARDUST = register(simple(item(
        "stardust", () -> new CloakedItemWithLoomPattern(
            IS.of(), PastelAdvancements.Milestones.UNLOCK_SHOOTING_STARS, PURPLE_DYE, PastelBannerPatterns.SHIMMER),
        InkColors.PURPLE
    )));
    ...
    public static final DeferredItem<Item> GERMINATED_JADE_VINE_BULB = register(simple(item(
        "germinated_jade_vine_bulb", () -> new GerminatedJadeVineBulbItem(
            IS.of(16), PastelAdvancements.Hidden.COLLECT_HIBERNATING_JADE_VINE_BULB, LIME_DYE), InkColors.LIME
    )));
    public static final DeferredItem<Item> JADE_VINE_PETALS = register(simple(item(
        "jade_vine_petals", () -> new CloakedItemWithLoomPattern(
            IS.of(), PastelAdvancements.Midgame.BUILD_SPIRIT_INSTILLER_STRUCTURE, LIME_DYE,
            PastelBannerPatterns.JADE_VINE
        ),
        InkColors.LIME
    ))); // TODO: Funky unlock?
    ...
    public static final DeferredItem<Item> BLOOD_ORCHID_PETAL = register(simple(item(
        "blood_orchid_petal", () -> new CloakedItem(
            IS.of(), PastelAdvancements.Milestones.REVEAL_BLOOD_ORCHID_PETALS, RED_DYE), InkColors.RED
    )));
    ...
    public static final DeferredItem<Item> NECTARDEW_BURGEON = register(simple(item(
        "nectardew_burgeon", () -> new NectardewBurgeonItem(
            ...
            PastelAdvancements.Lategame.COLLECT_NECTARDEW, PastelItems.NIGHTDEW_SPROUT.get()
        ), InkColors.PURPLE
    )));
...
//	(PastelFoodComponents.VITTORIAS_ROAST)), InkColors.PINK)));
    ...
    public static final DeferredItem<Item> MYCEYLON = register(simple(item(
        "myceylon", () -> new CloakedItem(IS.of(), PastelAdvancements.Lategame.COLLECT_MYCEYLON, ORANGE_DYE),
        InkColors.PINK
    )));
    ...
    public static final DeferredItem<Item> INCANDESCENT_ESSENCE = register(simple(burnable(
        item(
            "incandescent_essence", () -> new CloakedItem(
                IS
                    .of()
                    .fireResistant(), PastelAdvancements.Midgame.PASTEL_MIDGAME, ORANGE_DYE
            ), InkColors.ORANGE
        ), 2400
    )));
    public static final DeferredItem<Item> FROSTBITE_ESSENCE = register(simple(item(
        "frostbite_essence", () -> new CloakedItem(IS.of(), PastelAdvancements.Midgame.PASTEL_MIDGAME, LIGHT_BLUE_DYE),
        InkColors.LIGHT_BLUE
    )));
    public static final DeferredItem<Item> MOONSTONE_CORE = register(simple(item(
        "moonstone_core", () -> new CloakedItem(
            IS.of(16, Rarity.RARE), PastelAdvancements.Lategame.FIND_FORGOTTEN_CITY, WHITE_DYE), InkColors.WHITE
    )));
    ...
    public static final DeferredItem<KnowledgeGemItem> KNOWLEDGE_GEM = register(
        item("knowledge_gem", () -> new KnowledgeGemItem(IS.of(1, Rarity.UNCOMMON), 10000), InkColors.PURPLE));
